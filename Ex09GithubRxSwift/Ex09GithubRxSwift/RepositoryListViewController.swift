...
class RepositoryListViewController: UITableViewController {
    ...
    func fetchRepositories(of organizaion : String) {
        Observable.from([organizaion])
            .map { organizaion -> URL in
                return URL(string: "https://api.github.com/orgs/\(organizaion)/repos")!
            }
            ...
            .map { objects in
                objects.compactMap { dic -> Repository? in
                    ...
                    return Repository(id: id, name: name, description: description, stargazesCount: stargazersCount, language: language)
                }
            }
...
extension RepositoryListViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configure(repository: currentRepo)

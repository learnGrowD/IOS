...
class MainViewController : UIViewController {
    ...
    let submitButtom = UIBarButtonItem().then {
        $0.title = "제출"
        $0.style = .done
    }
        ...
        viewModel.cellData
            .drive(tableView.rx.items) { tv, row, data in
                ...
                case 0:
                    ...
                    cell.bind(viewModel.titleTextFiledCellViewModel)
                    return cell
                case 1:
                ...
                case 2:
                    ...
                    cell.bind(viewModel.priceTextFiledCellViewModel)
                    return cell
    ...
    private func attribute() {
        ...
        navigationItem.setRightBarButton(submitButtom, animated: true)
